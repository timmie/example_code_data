# -*- coding: utf-8 -*-
"""
Created on Wed Jul 24 22:32:14 2013
                ...
                if parse_cols is None or should_parse[j]:
                    if typ == XL_CELL_DATE:
                        ...
                        if dt[0] < datetime.MINYEAR:  # pragma: no cover
                            ...
                            # get this from the file name
                            # daydt = filename.split('.')[0][-10:]
                            
                            #get the basedate for this day
                            day_raw = '2013-07-02'
                            daydate = datetime.datetime.strptime(day_raw, '%Y-%m-%d')
                            # get the catual datetime
                            daydt = datetime.datetime.combine(daydate, value)
                            # apply offset                            
                            value = daydt - datetime.timedelta(minutes=10)
