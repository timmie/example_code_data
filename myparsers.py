...
#        print 'options', self.orig_options
...
#        print '\n myparsers df read', df.index, df. columns
...
#        print 'self.orig_names', self.columns
...
#            print '\n else', header, len(header)
#            print '\n have_mi_columns', have_mi_columns
            columns = []
            if have_mi_columns:
...
#                        print 'self.data[19]', self.data[19]
                        
                        #line =  self.data(self.header[0])
                        
#                        print 'line corr', line
                ...
                try:
                    ...
                    raise ValueError('Check the header value input.')
